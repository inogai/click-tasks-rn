      ...
      <Component
        ...
        className={cn(
          `
            ...
            web:select-text web:scroll-m-20
            lg:text-5xl
          `,
          className,
        )}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        className={cn(
          `
            native:mt-4 native:pl-3
            mt-6 border-l-2 border-border pl-6 text-base italic text-foreground
            web:select-text
          `,
          className,
        )}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        className={cn(
          `
            relative rounded-md bg-muted px-[0.3rem] py-[0.2rem] text-sm
